<%@ Page Title="" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true" CodeBehind="viewtask.aspx.cs" Inherits="hrManage.viewtask" %>
<asp:Content ID="Content1" ContentPlaceHolderID="headPlaceHoldar" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="bodyPlaceHolder" runat="server">

    <asp:GridView ID="GridView1" CssClass="  table table-hover table-bordered table-responsive alert-info "  runat="server" AllowSorting="True" AutoGenerateColumns="False" AutoGenerateDeleteButton="True" AutoGenerateEditButton="True" DataSourceID="SqlDataSource2">
...
<asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:mycon %>" SelectCommand="SELECT * FROM [Task2]" UpdateCommand="UPDATE [Task2] Set[task_name]=@task_name,[task_start_date]=@task_start_date,[task_update_date]=@task_update_date,[dpt_id]=@dpt_id Where[task_id]=@task_id" DeleteCommand="DELETE from [Task2] Where [task_id]=@task_id"></asp:SqlDataSource>
