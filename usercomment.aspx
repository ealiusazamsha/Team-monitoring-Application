<%@ Page Title="" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true" CodeBehind="usercomment.aspx.cs" Inherits="hrManage.usercomment" %>
<asp:Content ID="Content1" ContentPlaceHolderID="headPlaceHoldar" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="bodyPlaceHolder" runat="server">

    <asp:GridView ID="GridView1" CssClass="  table table-hover table-bordered table-responsive alert-info "  runat="server" AllowSorting="True" AutoGenerateColumns="False" AutoGenerateEditButton="True" DataSourceID="SqlDataSource2">
...
<asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:mycon %>" SelectCommand="SELECT * FROM [Task2]" UpdateCommand="UPDATE [Task2] Set [task_com]=@task_com Where[task_id]=@task_id" ></asp:SqlDataSource>
